...
- Home Assistant Ingress dashboard with sticky section navigation, dashboard Setup, separated Sources/Measurements diagnostics and optional HA state sensors.
